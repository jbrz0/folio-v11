      ...
      <div>
        ...
        <div className="projectIntro">
          ...
          <div className="projTextWrap projTextWrapBody">
            ...
            <LazyLoad height={0}><Gallery photos={ProjTwoPartTwo} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
            ...
            <LazyLoad height={0}><Gallery photos={ProjTwoPartFour} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
            ...
            <LazyLoad height={0}><Gallery photos={ProjTwoPartThree} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
            ...
            <LazyLoad height={0}><Gallery photos={ProjTwoPartFive} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
