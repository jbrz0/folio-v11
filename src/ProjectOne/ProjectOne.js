      ...
      <div>
        ...
        <div className="projectIntro">
          ...
          <div className="projTextWrap projTextWrapBody">
            ...
            <LazyLoad height={0}><Gallery photos={ProjOnePartTwo} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
            ...
            <LazyLoad height={0}><Gallery photos={ProjOnePartThree} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
            ...
            <LazyLoad height={0}><Gallery photos={ProjOnePartFour} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
            ...
            <LazyLoad height={0}><Gallery photos={ProjOnePartFive} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
