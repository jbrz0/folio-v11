    ...
    return (
      <div>
        ...
        <div className="projTextWrap projTextWrapBody">
          ...
          <LazyLoad height={300}><Gallery photos={ProjFivePartTwo} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
          ...
          <LazyLoad height={300}><Gallery photos={ProjFivePartFive} preloadNextImage={false} /></LazyLoad><div className="clearfix"></div>
